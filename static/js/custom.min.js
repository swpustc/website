...
h.data("dir","");if(f==="left"){h.cycle("next")}if(f==="right"){h.data("dir","prev");h.cycle("prev")}}d.swipe({swipeLeft:c,swipeRight:c,allowPageScroll:"auto"})}}})();(function(){if($(".tweet").length){$(".tweet").tweet({username:"fanfbmltemplate",page:1,avatar_size:40,count:4,loading_text:"loading ..."}).bind("loaded",function(){var c=$(this).find(".tweet_list")})}})();(function(){var d=$(".markdown"),e=d.find(".alignright-image");if(e.length){var c=function(){e.each(function(){var g=$(this),f=g.next();if(f){f.width(d.width()-g.outerWidth()-24)}})};c();$(window).load(c).resize(c)}})();(function(){var k=".domain-status-",H=$(k+"cdn"),i=$(k+"freeshell"),q=$(k+"static"),C=$("#map.cdn-map"),t=C.length,r="gmap-complete",u="addMarkers",f="removeAllMarkers",F=function(O,P){return $.Deferred(function(Q){if(P&&P!=""){if(O&&O!=""){if(O.match("image")!==null){$("<img/>").load(function(){Q.resolve()}).error(function(){Q.reject()}).attr("src",P)}else{if(O.match("json")!==null){$.getJSON(P,function(R){Q.resolve()}).error(function(){Q.reject()})}else{$.get(P,function(R){Q.resolve()}).error(function(){Q.reject()})}}}else{$.get(P,function(R){Q.resolve()}).error(function(){Q.reject()})}}else{Q.reject()}}).promise()},l=function(O){return $.Deferred(function(P){if(O&&O!=""){$.getJSON(O,function(Q){var R=0,T=0;for(var S in Q){T++}$.each(Q,function(U,V){$.when(F(U,V)).always(function(){if(++R==T){P.resolve()}})})}).error(function(){P.reject()})}else{P.reject()}}).promise()},z=function(P,O){return $.Deferred(function(Q){var S=function(){P.addClass(gmap_isSetup);Q.resolve()},R={address:"China",onComplete:S};if(O&&O!=""){$.getJSON(O,function(T){T.onComplete=S;P.gMap(T)}).error(function(){P.gMap(R)})}else{P.gMap(R)}}).promise()},w=function(P,O){return $.Deferred(function(Q){if(O&&O!=""){$.getJSON(O,function(R){P.gMap(f);P.gMap(u,R);Q.resolve()}).error(function(){Q.reject()})}else{Q.reject()}}).promise()},m="json-",J=m+"preload",j=m+"center",g=m+"marker",o=10000,G=500;if(H.length||i.length||q.length||t){var p=".swpbox.info",x="/domain-test.png?t=",h="//freeshell"+p+x,v="//static"+p+x,s=null,A=null,I="highlight",e=I+"1",n=I+"2",K=I+"3",d=I+"4",y=" ",E=e+y+n+y+K+y+d,B=function(O){return $.Deferred(function(P){if(O&&O!=""){$("<img/>").load(function(){P.resolve()}).error(function(){P.reject()}).attr("src",O+(new Date()).getTime())}else{P.reject()}}).promise()},M="-nl",c="-up",D="-dn",L={a:function(){$.when(B(h)).done(function(){if(s!==true){s=true;i.each(function(){$(this).removeClass(E).addClass(n)});H.each(function(){$(this).removeClass(E).addClass(A===null?d:(A?n:d))});if(t){var O=0;C.each(function(){var Q=$(this),P=g+c+(A===null?M:(A?c:D));$.when(w(Q,Q.attr(P))).fail(function(){s=false}).always(function(){if(++O==t){setTimeout(L.b,G)}})})}else{setTimeout(L.b,G)}}else{setTimeout(L.b,G)}}).fail(function(){if(s!==false){s=false;i.each(function(){$(this).removeClass(E).addClass(K)});H.each(function(){$(this).removeClass(E).addClass(A===null?e:(A?d:K))});if(t){var O=0;C.each(function(){var Q=$(this),P=g+D+(A===null?M:(A?c:D));$.when(w(Q,Q.attr(P))).fail(function(){s=true}).always(function(){if(++O==t){setTimeout(L.b,G)}})})}else{setTimeout(L.b,G)}}else{setTimeout(L.b,G)}})},b:function(){$.when(B(v)).done(function(){if(A!==true){A=true;q.each(function(){$(this).removeClass(E).addClass(n)});H.each(function(){$(this).removeClass(E).addClass(s?n:d)});if(t){var O=0;C.each(function(){var Q=$(this),P=g+(s?c:D)+c;$.when(w(Q,Q.attr(P))).fail(function(){A=false}).always(function(){if(++O==t){setTimeout(L.a,o)}})})}else{setTimeout(L.a,o)}}else{setTimeout(L.a,o)}}).fail(function(){if(A!==false){A=false;q.each(function(){$(this).removeClass(E).addClass(K)});H.each(function(){$(this).removeClass(E).addClass(s?d:K)});if(t){var O=0;C.each(function(){var Q=$(this),P=g+(s?c:D)+D;$.when(w(Q,Q.attr(P))).fail(function(){A=true}).always(function(){if(++O==t){setTimeout(L.a,o)}})})}else{setTimeout(L.a,o)}}else{setTimeout(L.a,o)}})}};if(t){var N=0;C.each(function(){var R=$(this),O=R.attr(J),P=R.attr(j),Q=R.attr(g);$.when(l(O)).always(function(){$.when(z(R,P)).always(function(){$.when(w(R,Q)).always(function(){if(++N==t){setTimeout(L.a,G)}})})})})}else{setTimeout(L.a,G)}}else{$("#map").each(function(){var R=$(this),O=R.attr(J),P=R.attr(j),Q=R.attr(g);$.when(l(O)).always(function(){$.when(z(R,P)).always(function(){w(R,Q)})})})}})();(function(){$(".spanwords").each(function(){var d=$(this),c=d.text().replace(/./g,"<span>$&</span>");d.html(c)})})()});(function(){$.fn.jflickrfeed=function(c,e){c=$.extend(true,{flickrbase:"http://api.flickr.com/services/feeds/",feedapi:"photos_public.gne",limit:20,qstrings:{lang:"en-us",format:"json",jsoncallback:"?"},cleanDescription:true,useTemplate:true,itemTemplate:"",itemCallback:function(){}},c);var a=c.flickrbase+c.feedapi+"?";var d=true;for(var b in c.qstrings){if(!d){a+="&"}a+=b+"="+c.qstrings[b];d=false}return $(this).each(function(){var g=$(this);var f=this;$.getJSON(a,function(h){$.each(h.items,function(m,p){if(m<c.limit){if(c.cleanDescription){var o=/<p>(.*?)<\/p>/g;
var j=p.description;if(o.test(j)){p.description=j.match(o)[2];if(p.description!=undefined){p.description=p.description.replace("<p>","").replace("</p>","")}}}p["image_s"]=p.media.m.replace("_m","_s");p["image_t"]=p.media.m.replace("_m","_t");p["image_m"]=p.media.m.replace("_m","_m");p["image"]=p.media.m.replace("_m","");p["image_b"]=p.media.m.replace("_m","_b");delete p.media;if(c.useTemplate){var n=c.itemTemplate;for(var l in p){var k=new RegExp("{{"+l+"}}","g");n=n.replace(k,p[l])}g.append(n)}c.itemCallback.call(f,p)}});if($.isFunction(e)){e.call(f,h)}})})}})();jQuery.cookie=function(b,j,m){if(typeof j!="undefined"){m=m||{};if(j===null){j="";m.expires=-1}var e,l,g,a;if(typeof m.expires!="undefined"&&m.expires===null){e=""}else{if(m.expires&&(typeof m.expires=="number"||m.expires.toUTCString)){var f;if(typeof m.expires=="number"){f=new Date();f.setTime(f.getTime()+(m.expires*86400000))}else{f=m.expires}e="; expires="+f.toUTCString()}else{e="; expires=Fri, 01 Jan 2100 00:00:00 GMT"}}if(typeof m.path!="undefined"&&m.path===null){l=""}else{if(m.path){l="; path="+(m.path)}else{l="; path=/"}}if(typeof m.domain!="undefined"&&m.domain===null){g=""}else{if(m.domain){g="; domain="+(m.domain)}else{g="; domain=swpbox.info"}}if(typeof m.secure!="undefined"&&m.secure===null){a=""}else{if(m.secure){a="; secure"}else{a=""}}document.cookie=[b,"=",encodeURIComponent(j),e,l,g,a].join("")}else{var d=null;if(document.cookie&&document.cookie!=""){var k=document.cookie.split(";");for(var h=0;h<k.length;h++){var c=jQuery.trim(k[h]);if(c.substring(0,b.length+1)==(b+"=")){d=decodeURIComponent(c.substring(b.length+1));break}}}return d}};
