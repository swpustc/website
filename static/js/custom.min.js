...
h.data("dir","");if(f==="left"){h.cycle("next")}if(f==="right"){h.data("dir","prev");h.cycle("prev")}}d.swipe({swipeLeft:c,swipeRight:c,allowPageScroll:"auto"})}}})();(function(){if($(".tweet").length){$(".tweet").tweet({username:"fanfbmltemplate",page:1,avatar_size:40,count:4,loading_text:"loading ..."}).bind("loaded",function(){var c=$(this).find(".tweet_list")})}})();(function(){var d=$(".markdown"),e=d.find(".alignright-image");if(e.length){var c=function(){e.each(function(){var g=$(this),f=g.next();if(f){f.width(d.width()-g.outerWidth()-24)}})};c();$(window).load(c).resize(c)}})();(function(){var k=".domain-status-",I=$(k+"cdn"),i=$(k+"freeshell"),q=$(k+"static"),C=$("#map.cdn-map"),t=C.length,r="gmap-complete",u="addMarkers",f="removeAllMarkers",F=function(P,Q){return $.Deferred(function(R){if(Q&&Q!=""){if(!P||P==""){P="html"}if(P.match("image")!==null){$("<img/>").load(function(){R.resolve()}).error(function(){R.reject()}).attr("src",Q)}else{if(P.match("json")!==null){$.getJSON(Q,function(S){R.resolve()}).error(function(){R.reject()})}else{if(P.match("load")!==null){$("<div/>").load(Q,function(){R.resolve()}).error(function(){R.reject()})}else{$.get(Q,function(S){R.resolve()}).error(function(){R.reject()})}}}}else{R.reject()}}).promise()},l=function(P){return $.Deferred(function(Q){if(P&&P!=""){$.getJSON(P,function(R){var S=0,U=0;for(var T in R){U++}$.each(R,function(V,W){$.when(F(V,W)).always(function(){if(++S==U){Q.resolve()}})})}).error(function(){Q.reject()})}else{Q.reject()}}).promise()},z=function(Q,P){return $.Deferred(function(R){var T=function(){Q.addClass(r);R.resolve()},S={address:"China",onComplete:T};if(P&&P!=""){$.getJSON(P,function(U){U.onComplete=T;Q.gMap(U)}).error(function(){Q.gMap(S)})}else{Q.gMap(S)}}).promise()},w=function(Q,P){return $.Deferred(function(R){if(P&&P!=""){$.getJSON(P,function(S){Q.gMap(f);Q.gMap(u,S);R.resolve()}).error(function(){R.reject()})}else{R.reject()}}).promise()},m="json-",K=m+"preload",j=m+"center",g=m+"marker",o=10000,H=500;if(I.length||i.length||q.length||t){var p=".swpbox.info",x="/domain-test.png?t=",h="//freeshell"+p+x,v="//static"+p+x,s=null,A=null,J="highlight",e=J+"1",n=J+"2",L=J+"3",d=J+"4",G=J+"5",y=" ",E=e+y+n+y+L+y+d+y+G,B=function(P){return $.Deferred(function(Q){if(P&&P!=""){$("<img/>").load(function(){Q.resolve()}).error(function(){Q.reject()}).attr("src",P+(new Date()).getTime())}else{Q.reject()}}).promise()},N="-nl",c="-up",D="-dn",M={a:function(){$.when(B(h)).done(function(){if(s!==true){s=true;I.each(function(){$(this).removeClass(E).addClass(A===null?d:(A?n:d))});i.each(function(){$(this).removeClass(E).addClass(n)});if(A===null){q.each(function(){$(this).removeClass(E).addClass(G)})}if(t){var P=0;C.each(function(){var R=$(this),Q=g+c+(A===null?N:(A?c:D));$.when(w(R,R.attr(Q))).fail(function(){s=false}).always(function(){if(++P==t){setTimeout(M.b,H)}})})}else{setTimeout(M.b,H)}}else{setTimeout(M.b,H)}}).fail(function(){if(s!==false){s=false;I.each(function(){$(this).removeClass(E).addClass(A===null?e:(A?d:L))});i.each(function(){$(this).removeClass(E).addClass(L)});if(A===null){q.each(function(){$(this).removeClass(E).addClass(G)})}if(t){var P=0;C.each(function(){var R=$(this),Q=g+D+(A===null?N:(A?c:D));$.when(w(R,R.attr(Q))).fail(function(){s=true}).always(function(){if(++P==t){setTimeout(M.b,H)}})})}else{setTimeout(M.b,H)}}else{setTimeout(M.b,H)}})},b:function(){$.when(B(v)).done(function(){if(A!==true){A=true;I.each(function(){$(this).removeClass(E).addClass(s?n:d)});q.each(function(){$(this).removeClass(E).addClass(n)});if(t){var P=0;C.each(function(){var R=$(this),Q=g+(s?c:D)+c;$.when(w(R,R.attr(Q))).fail(function(){A=false}).always(function(){if(++P==t){setTimeout(M.a,o)}})})}else{setTimeout(M.a,o)}}else{setTimeout(M.a,o)}}).fail(function(){if(A!==false){A=false;I.each(function(){$(this).removeClass(E).addClass(s?d:L)});q.each(function(){$(this).removeClass(E).addClass(L)});if(t){var P=0;C.each(function(){var R=$(this),Q=g+(s?c:D)+D;$.when(w(R,R.attr(Q))).fail(function(){A=true}).always(function(){if(++P==t){setTimeout(M.a,o)}})})}else{setTimeout(M.a,o)}}else{setTimeout(M.a,o)}})}};if(t){var O=0;C.each(function(){var S=$(this),P=S.attr(K),Q=S.attr(j),R=S.attr(g);$.when(l(P)).always(function(){$.when(z(S,Q)).always(function(){$.when(w(S,R)).always(function(){if(++O==t){setTimeout(M.a,H)}})})})})}else{setTimeout(M.a,H)}}else{$("#map").each(function(){var S=$(this),P=S.attr(K),Q=S.attr(j),R=S.attr(g);$.when(l(P)).always(function(){$.when(z(S,Q)).always(function(){w(S,R)})})})}})();(function(){$(".spanwords").each(function(){var d=$(this),c=d.text().replace(/./g,"<span>$&</span>");d.html(c)})})()});(function(){$.fn.jflickrfeed=function(c,e){c=$.extend(true,{flickrbase:"http://api.flickr.com/services/feeds/",feedapi:"photos_public.gne",limit:20,qstrings:{lang:"en-us",format:"json",jsoncallback:"?"},cleanDescription:true,useTemplate:true,itemTemplate:"",itemCallback:function(){}},c);var a=c.flickrbase+c.feedapi+"?";var d=true;for(var b in c.qstrings){if(!d){a+="&"
}a+=b+"="+c.qstrings[b];d=false}return $(this).each(function(){var g=$(this);var f=this;$.getJSON(a,function(h){$.each(h.items,function(m,p){if(m<c.limit){if(c.cleanDescription){var o=/<p>(.*?)<\/p>/g;var j=p.description;if(o.test(j)){p.description=j.match(o)[2];if(p.description!=undefined){p.description=p.description.replace("<p>","").replace("</p>","")}}}p["image_s"]=p.media.m.replace("_m","_s");p["image_t"]=p.media.m.replace("_m","_t");p["image_m"]=p.media.m.replace("_m","_m");p["image"]=p.media.m.replace("_m","");p["image_b"]=p.media.m.replace("_m","_b");delete p.media;if(c.useTemplate){var n=c.itemTemplate;for(var l in p){var k=new RegExp("{{"+l+"}}","g");n=n.replace(k,p[l])}g.append(n)}c.itemCallback.call(f,p)}});if($.isFunction(e)){e.call(f,h)}})})}})();jQuery.cookie=function(b,j,m){if(typeof j!="undefined"){m=m||{};if(j===null){j="";m.expires=-1}var e,l,g,a;if(typeof m.expires!="undefined"&&m.expires===null){e=""}else{if(m.expires&&(typeof m.expires=="number"||m.expires.toUTCString)){var f;if(typeof m.expires=="number"){f=new Date();f.setTime(f.getTime()+(m.expires*86400000))}else{f=m.expires}e="; expires="+f.toUTCString()}else{e="; expires=Fri, 01 Jan 2100 00:00:00 GMT"}}if(typeof m.path!="undefined"&&m.path===null){l=""}else{if(m.path){l="; path="+(m.path)}else{l="; path=/"}}if(typeof m.domain!="undefined"&&m.domain===null){g=""}else{if(m.domain){g="; domain="+(m.domain)}else{g="; domain=swpbox.info"}}if(typeof m.secure!="undefined"&&m.secure===null){a=""}else{if(m.secure){a="; secure"}else{a=""}}document.cookie=[b,"=",encodeURIComponent(j),e,l,g,a].join("")}else{var d=null;if(document.cookie&&document.cookie!=""){var k=document.cookie.split(";");for(var h=0;h<k.length;h++){var c=jQuery.trim(k[h]);if(c.substring(0,b.length+1)==(b+"=")){d=decodeURIComponent(c.substring(b.length+1));break}}}return d}};
